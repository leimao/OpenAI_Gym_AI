...
def Train_Model(env = env):
    ...
    while episode < EPISODE_MAX:
        ...
        while True:  
            ...
            train_loss_actor, train_loss_critic = AI_player.Train(observation = observation, action = action, reward = reward, done = done, observation_next = observation_next, action_next = action_next)
            ...
            if done:
                ...
                print("Current Critic Train Loss: %f" % train_loss_critic)

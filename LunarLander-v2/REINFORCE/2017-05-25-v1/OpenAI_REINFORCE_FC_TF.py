...
class OpenAI_REINFORCE_FC():
    ...
    def Calculate_Value(self):
        ...
        # Discount factors
        discount_factors = np.zeros_like(self.episode_rewards)
        discount_factors[0] = 1
        for t in range(1, len(self.episode_rewards)):
            discount_factors[t] = GAMMA * discount_factors[t-1]

        # State values dicounted by discount factors
        state_values = state_values * discount_factors
